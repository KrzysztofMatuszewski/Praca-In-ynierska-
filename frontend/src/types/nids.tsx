// Interface definitions for NIDS data
...
export interface WeightsHeatmapData {
  ...
  export interface ModelData {
    ...
    weights_heatmap_data?: { [folder: string]: WeightsHeatmapData };
  ...
  export interface NetworkWeightsHeatmapProps {
    weightsData: { [folder: string]: any };
