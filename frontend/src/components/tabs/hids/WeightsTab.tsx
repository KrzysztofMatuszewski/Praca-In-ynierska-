...
import { WeightsHeatmapData } from '@/types/hids';
...
interface WeightsTabProps {
  ...
  selectedHidsFolder: string;
  setSelectedHidsFolder: (folder: string) => void;
  loading: boolean;
}
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mb-4">
            ...
            <Select 
              value={selectedHidsFolder} 
              onValueChange={setSelectedHidsFolder}
          ...
          {Object.keys(weightsHeatmapData).length > 0 && selectedHidsFolder ? (
